...
object PartialFunctions extends App {
  ...
  // {1,2,5} => Int Is a partial function of the domain of Int. Only accepts a subset of Int {1,2,5}
  ...
  // println(aPartialFunction(56)) --> Error
  ...
  // another way to use a partial Function without sugar syntax
